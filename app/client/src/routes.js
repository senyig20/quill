    ...
    .config([
        ...
        function (
            ...
            $stateProvider
                ...
                .state('app.defnesAdmin', {
                    views: {
                        '': {
                            templateUrl: "views/defnesAdmin/admin.html",
                ...
                .state('app.defnesAdmin.stats', {
                    url: "/godmode",
                    templateUrl: "views/defnesAdmin/stats/stats.html",
                    controller: 'DAdminStatsCtrl'
                })
                .state('app.defnesAdmin.exportteams', {
                    url: "/godmode/exportteams",
                    templateUrl: "views/defnesAdmin/exportteams/exportTeams.html",
                    controller: 'DAdminExportTeamsCtrl'
                })
                .state('app.defnesAdmin.users', {
                    url: "/godmode/users?" +
                        '&page' +
                        '&size' +
                        '&query',
                    templateUrl: "views/defnesAdmin/users/users.html",
                    controller: 'DAdminUsersCtrl'
                })
                .state('app.defnesAdmin.user', {
                    url: "/godmode/users/:id",
                    templateUrl: "views/defnesAdmin/user/user.html",
                ...
                .state('app.defnesAdmin.settings', {
